...
* stabilize repository after license addition and history rewrite
* fix publish workflow to prevent republishing existing versions
* temporarily disable Release Please to prevent historical tag recreation
